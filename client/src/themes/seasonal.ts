...
export const THEMES: SeasonalTheme[] = [
...

  {
    ...
    vars: {
      ...
      '--th-page-tint':    'rgba(74,222,128,0.03)',
      '--th-card-glow':    'rgba(74,222,128,0.20)',
      '--th-price':        '#86efac',
      '--th-logo-border':  'rgba(74,222,128,0.38)',
      '--th-logo-bg':      'rgba(74,222,128,0.13)',
      '--th-nav-border':   'rgba(74,222,128,0.22)',
    },
  },
