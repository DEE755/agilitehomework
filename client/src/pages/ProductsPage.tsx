  ...
  return (
    <div>
      ...
      <div className="mb-6 flex items-start gap-3 rounded-lg border border-amber-500/30 bg-amber-500/5 px-4 py-3">
        ...
        <div>
          <p className="text-xs font-semibold uppercase tracking-wide text-amber-400">Product Catalog Updated — April 11, 2026</p>
          <p className="mt-0.5 text-xs text-zinc-400">
            Old products or categories might not be available anymore.
          </p>
        </div>
      </div>
