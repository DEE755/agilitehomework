  ...
  return (
    <div>
      ...
      <div className="mb-6 flex items-start gap-3 rounded-lg border border-amber-500/30 bg-amber-500/5 px-4 py-3">
        ...
        <div>
          <p className="text-xs font-semibold uppercase tracking-wide text-amber-400">Data Integrity Warning — April 11, 2026</p>
          <p className="mt-0.5 text-xs text-zinc-400">
            Our third-party product API has been compromised by malicious actors who injected mismatched data — product names may not correspond to their images or categories. This is an external data integrity issue outside our control.
          </p>
        </div>
      </div>
